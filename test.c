 ...
 *  Copyright (C) 2002, 2021 Tydeman Consulting.  All rights reserved.
 *
 ...
 *      0 Intel Pentium 4    Windows XP        LCC 2003/01/12; no unsigned long
 * long 0 Intel Pentium 4    Windows XP        LCC 2004/07/30 0 Intel Pentium 4
 *   Windows XP        LCC 2008/07/24 -ansic
 * >=  18 Intel Pentium 4    Windows XP        LCC 2002/06/17
 * >=  18 Intel Pentium 4    Windows XP        LCC 2003/07/11
 * >=  19 Intel Core2 Duo    Linux Fedora 17   Intel C/C++ icc 13.1 -std=c99
 * -mia32 -O0 -fp-model strict -fp-model extended
 * >=  19 Intel Core2 Duo    Linux Fedora 17   Intel C/C++ icc 13.1 -std=gnu99
 * -mia32 -O0 -fp-model strict -fp-model extended
 * >=  29 Intel Core2 Duo    Linux Fedora 17   Intel C/C++ icc 13.1 -std=c99
 * -xSSSE3 -O0 -fp-model strict -fp-model source
 * >=  29 Intel Core2 Duo    Linux Fedora 17   Intel C/C++ icc 13.1 -std=gnu99
 * -xSSSE3 -O0 -fp-model strict -fp-model source
 * >=  54 Intel Pentium 4    Windows XP        LCC 2002/06/09
 * >=  65 Intel Core2 Duo    Linux Fedora 17   Intel C/C++ icc 13.1 -std=c99 -O0
 * -fp-model strict -fp-model double
 * >=  72 Intel Core2 Duo    Windows Vista     LCC 2012/10/22
 * >=  75 Intel Pentium 4    Windows XP        LCC 2002/06/06
 * >= 108 ARM Cortex A53     Linux Fedora 33   gcc 10.2.1 -std=gnu2x -O0
 * -march=armv8-a -mcpu=cortex-a53
 * >= 108 ARM Cortex A53     Linux Fedora 34   gcc 11.2.1 -std=gnu2x -O0
 * -march=armv8-a -mcpu=cortex-a53
 * >= 108 ARM Cortex A53     Linux Manjaro     gcc 10.2.0 -std=gnu2x -O0
 * -march=armv8-a -mcpu=cortex-a53
 * >= 108 ARM Cortex A53     Linux Manjaro     gcc 9.3.0 -std=gnu2x -O0
 * -march=armv8-a -mcpu=cortex-a53
 * >= 108 ARM Cortex A72     Linux Fedora 33   gcc 10.2.1 -std=gnu2x -O0
 * -march=armv8-a -mcpu=cortex-a72
 * >= 108 ARM Cortex A72     Linux Fedora 34   gcc 11.2.1 -std=gnu2x -O0
 * -march=armv8-a -mcpu=cortex-a72
 * >= 108 ARM Cortex A72     Linux Manjaro     gcc 10.2.0 -std=gnu2x -O0
 * -march=armv8-a -mcpu=cortex-a72
 * >= 108 ARM Cortex A72     Linux Manjaro     gcc 9.3.0 -std=gnu2x -O0
 * -march=armv8-a -mcpu=cortex-a72
 * >= 108 ARM aarch64        ?                 clang 10.0.0 -O0
 * >= 108 IBM Power 6        AIX 6.1.7.17      IBM XL C/C++ for AIX V11.1
 * >= 109 ARM Cortex A53     Linux Fedora 33   clang 11.0.0 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a53 -ffp-model=strict
 * >= 109 ARM Cortex A53     Linux Fedora 34   clang 12.0.1 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a53 -ffp-model=strict
 * >= 109 ARM Cortex A53     Linux Manjaro     clang 11.0.0 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a53 -ffp-model=strict
 * >= 109 ARM Cortex A53     Linux Manjaro     clang 12.0.1 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a53 -ffp-model=strict
 * >= 109 ARM Cortex A72     Linux Fedora 33   clang 11.0.0 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a72 -ffp-model=strict
 * >= 109 ARM Cortex A72     Linux Fedora 34   clang 12.0.1 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a72 -ffp-model=strict
 * >= 109 ARM Cortex A72     Linux Manjaro     clang 11.0.0 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a72 -ffp-model=strict
 * >= 109 ARM Cortex A72     Linux Manjaro     clang 12.0.1 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a72 -ffp-model=strict
 * >= 111 ARM Cortex A53     Linux Manjaro     clang 10.0.0 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a53 -ffp-model=strict
 * >= 111 ARM Cortex A53     Linux Manjaro     clang 10.0.1 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a53 -ffp-model=strict
 * >= 111 ARM Cortex A72     Linux Manjaro     clang 10.0.0 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a72 -ffp-model=strict
 * >= 111 ARM Cortex A72     Linux Manjaro     clang 10.0.1 -std=c2x -O0 -m64
 * -march=armv8-a -mcpu=cortex-a72 -ffp-model=strict
 * >= 127 Intel Pent 4 IA-32 Linux Fedora 10   Intel C/C++ icc 11.1 -std=c99
 * -strict-ansi -mia32 -fp-model strict -O0
 * >= 127 Intel Pent 4 IA-32 Linux Fedora 10   Intel C/C++ icc 11.1 -std=c99
 * -strict-ansi -msse -fp-model strict -O0
 ...
 * >= 138 Intel Pentium III  RedHat Linux 8    Gnu gcc 3.3.1 +
 * glibc 2.3.2-4.80.6 (no long long)
 * >= 165 Apple PowerPC G3   Linux 2.4.19      Gnu gcc 3.2.2 w/ glibc ?; no long
 * long
 * >= 165 DEC Alpha          Linux 2.4.18      Gnu gcc 3.3.1; no long long
 * >= 165 HP PA RISC rp5470  Linux 3.0         cc 3.0.4; no long long
 * >= 165 Intel Core i5-32   Linux Fedora 24   gcc 6.1.1 -std=gnu11 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-32   Linux Fedora 25   clang 3.9.1 -std=c11 -m32 -mx87
 * -mno-sse
 * >= 165 Intel Core i5-32   Linux Fedora 25   gcc 6.4.1 -std=gnu11 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-32   Linux Fedora 26   clang 4.0.1 -std=c11 -m32 -mx87
 * -mno-sse
 * >= 165 Intel Core i5-32   Linux Fedora 26   gcc 7.3.1 -std=gnu11 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-32   Linux Fedora 27   clang 5.0.2 -std=c11 -m32 -mx87
 * -mno-sse
 * >= 165 Intel Core i5-32   Linux Fedora 27   gcc 7.3.1 -std=gnu11 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-32   Linux Fedora 28   clang 6.0.1 -std=c17 -m32 -mx87
 * -mno-sse
 * >= 165 Intel Core i5-32   Linux Fedora 28   gcc 8.2.1 -std=gnu17 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-32   Linux Fedora 29   clang 7.0.0 -std=c17 -m32 -mx87
 * -mno-sse
 * >= 165 Intel Core i5-32   Linux Fedora 29   gcc 8.2.1 -std=gnu17 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-32   Linux Fedora 29   gcc 8.3.1 -std=gnu17 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-32   Linux Fedora 30   clang 8.0.0 -std=c17 -m32 -mx87
 * -mno-sse
 * >= 165 Intel Core i5-32   Linux Fedora 30   gcc 9.3.1 -std=gnu2x -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 25   gcc 6.4.1 -std=gnu11 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 26   gcc 7.1.1 -std=gnu11 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 27   gcc 7.3.1 -std=gnu11 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 28   gcc 8.1.1 -std=gnu11 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 29   gcc 8.2.1 -std=gnu17 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 29   gcc 8.3.1 -std=gnu17 -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 30   gcc 9.1.1 -std=gnu2x -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 31   gcc 9.2.1 -std=gnu2x -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 31   gcc 9.3.1 -std=gnu2x -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 32   gcc 10.1.1 -std=gnu2x -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Linux Fedora 33   gcc 10.2.1 -std=gnu2x -mieee-fp
 * -mfpmath=387
 * >= 165 Intel Core i5-64   Windows 10        Digital Mars C/C++ v8.57c -A99 -f
 * -6
 * >= 165 Intel Core i5-64   Windows 10        Embarcadero C/C++ 10.2/7.3 for
 * Win32 -DNEED_TRAPS_DISABLED
 * >= 165 Intel Core i7-64   Ubuntu 3.2.0-40   gcc 4.6.3 + eglibc 2.15-0
 * >= 165 Intel Core2 Duo    Linux Fedora 17   gcc 4.7.0-2 + glibc 2.15-32;
 * -std=gnu11 -mieee-fp
 * >= 165 Intel Pentium Pro  OS/2 v4           Gnu gcc 2.8.1 + emx 0.9d; no long
 * long
 ...
 * >= 166 Intel Core2 Duo    Linux Fedora 14   Gnu gcc 4.5.1-4 +
 * glibc 2.12.90-15; -std=gnu99 -frounding-math
 * >= 166 Intel Core2 Duo    Linux Fedora 15   Gnu gcc 4.6.1-9 + glibc 2.14-5;
 * -std=gnu99 -frounding-math
 * >= 166 Intel Core2 Duo    Linux Fedora 16   Gnu gcc 4.6.2-1 +
 * glibc 2.14.90-21; -std=gnu99 -frounding-math
 * >= 166 Intel Core2 Duo-64 Linux Fedora 10   Intel C/C++ icc 11.1 -std=c99
 * -fp-model strict (x86_64)
 * >= 166 Intel Pentium 4    Linux Fedora  6   Gnu gcc 4.1.2-13.fc6 +
 * glibc 2.5-18.fc6
 ...
 * >= 166 Intel Pentium 4    Linux Fedora 14   Gnu gcc 4.5.1-4 +
 * glibc 2.12.90-15; -std=gnu99 -frounding-math
 * >= 168 Intel Pentium 4    RedHat Linux 8    EDG 3.4 w/ Gnu gcc 3.2 +
 * glibc 2.2.93
 ...
 * >= 168 Intel Pentium III  RedHat Linux 8    Comeau 4.3.0.1 w/ Gnu gcc 3.2 +
 * glibc 2.2.93
 * >= 168 Intel Pentium III  RedHat Linux 8    EDG 3.2 w/ Gnu gcc 3.2 +
 * glibc 2.2.93
 * >= 168 Intel Pentium III  RedHat Linux 8    EDG 3.3 w/ Gnu gcc 3.2 +
 * glibc 2.2.93
 * >= 168 Intel Pentium III  RedHat Linux 8    Gnu gcc 3.2 + glibc 2.2.93
 * >= 173 Intel Pent 4 IA-32 Linux Fedora 10   Intel C/C++ icc 11.1 -std=c99
 * -strict-ansi -fp-model strict -O0
 * >= 173 Intel Pent 4 IA-32 Linux Fedora 10   Intel C/C++ icc 11.1 -std=c99
 * -strict-ansi -msse2 -fp-model strict -O0
 * >= 183 Intel Core i5-32   Linux Fedora 24   gcc 6.1.1 -std=gnu11 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-32   Linux Fedora 25   gcc 6.4.1 -std=gnu11 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-32   Linux Fedora 26   gcc 7.3.1 -std=gnu11 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-32   Linux Fedora 27   gcc 7.3.1 -std=gnu11 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-32   Linux Fedora 28   gcc 8.2.1 -std=gnu17 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-32   Linux Fedora 29   gcc 8.2.1 -std=gnu17 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-32   Linux Fedora 29   gcc 8.3.1 -std=gnu17 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-32   Linux Fedora 30   gcc 9.3.1 -std=gnu2x -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 14   pcc 0.9.9 (2010/11/19) +
 * glibc-2.13-1 (x86_64)
 * >= 183 Intel Core i5-64   Linux Fedora 15   gcc 4.6.0-9 (2011/05/30) +
 * glibc-2.14-3 (x86_64)
 * >= 183 Intel Core i5-64   Linux Fedora 16   gcc 4.6.3-2 + glibc-2.14.90-24
 * (x86_64)
 * >= 183 Intel Core i5-64   Linux Fedora 18   gcc 4.7.2-8 + glibc-2.16-24
 * (x86_64) -std=gnu11 -mfpmath=387
 * >= 183 Intel Core i5-64   Linux Fedora 18   gcc 4.7.2-8 + glibc-2.16-24
 * (x86_64) -std=gnu11 -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 25   gcc 6.4.1 -std=gnu11 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 26   gcc 7.1.1 -std=gnu11 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 27   gcc 7.3.1 -std=gnu11 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 28   gcc 8.1.1 -std=gnu11 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 29   gcc 8.2.1 -std=gnu17 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 29   gcc 8.3.1 -std=gnu17 -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 30   gcc 9.1.1 -std=gnu2x -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 31   clang 9.0.0 -std=c2x -m64
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 31   gcc 9.2.1 -std=gnu2x -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 31   gcc 9.3.1 -std=gnu2x -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 32   aocc 2.1.0 -std=c2x -O0 -m64
 * -mfpmath=sse -fno-fast-math
 * >= 183 Intel Core i5-64   Linux Fedora 32   clang 10.0.0 -std=c2x -m64
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 32   gcc 10.1.1 -std=gnu2x -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 33   clang 11.0.0 -std=c2x -m64
 * -mfpmath=sse
 * >= 183 Intel Core i5-64   Linux Fedora 33   gcc 10.2.1 -std=gnu2x -mieee-fp
 * -mfpmath=sse
 * >= 183 Intel Core i7-64   Linux debian6     gcc 4.4.5-8 + glibc (x86_64)
 * >= 183 Intel Core2 Duo    Linux Fedora 17   gcc 4.7.0-2 + glibc 2.15-32;
 * -std=gnu11 -mfpmath=sse -mieee-fp
 * >= 183 Intel Core2 Duo-64 Linux Fedora 10   gcc 4.3.2-7 + glibc-2.9-3
 * (x86_64)
 * >= 184 Intel Core i5-32   Linux Fedora 25   pcc 1.1.0 (2016/12/01)
 * >= 184 Intel Core i5-32   Linux Fedora 28   pcc 1.1.0 (2018/02/28)
 * >= 184 Intel Core i5-32   Linux Fedora 29   pcc 1.1.0 (2018/05/04)
 * >= 184 Intel Core i5-32   Linux Fedora 30   pcc 1.1.0 (2020/02/03)
 * >= 184 Intel Core2 Duo    Linux Fedora 16   pcc 1.0.0-2 (2011/12/16) +
 * glibc-2.14.90-24
 * >= 192 Intel Core i5-64   Linux Fedora 14   pcc 1.0.0 (2011/04/01) +
 * glibc-2.13-1 (x86_64)
 * >= 192 Intel Core i5-64   Linux Fedora 26   Oracle Studio 12.6
 * >= 192 Intel Core i5-64   Linux Fedora 26   open64 4.5.2.1 -std=c99 -mieee-fp
 * -msse2 -fno-fast-math -fno-unsafe-math-optimizations
 * >= 192 Intel Core i5-64   Linux Fedora 26   open64 5.0.0 -std=c99 -mieee-fp
 * -msse2 -fno-fast-math -fno-unsafe-math-optimizations
 * >= 192 Intel Core i5-64   Linux Fedora 30   clang 8.0.0 -std=c2x -m64
 * -mfpmath=sse
 ...
 * >= 192 Intel Pentium 4    Linux Fedora 14   Portable C Compiler pcc 0.9.9
 * 2010/11/19
 ...
 * >= 192 Intel Pentium III  OS/2 v4           Gnu gcc 2.7.2.1 + emx 0.9c +
 * fix02
 * >= 192 Intel Pentium III  OS/2 v4           Gnu gcc 2.8.1 + emx 0.9d
 * >= 192 Intel Pentium III  OS/2 v4           Open Watcom C/C++ 1.0
 * >= 192 Intel Pentium III  RedHat Linux 7    Intel C/C++ icc 7 w/ Gnu gcc 2.96
 * + glibc 2.1.92
 * >= 192 Intel Pentium III  RedHat Linux 8    Intel C/C++ icc 7 w/ Gnu gcc 3.2
 * + glibc 2.2.93
 * >= 192 Intel Pentium III  RedHat Linux 8    Intel C/C++ icc 7.1 w/ Gnu
 * gcc 3.3.1 + glibc 2.3.2-4.80.6
 ...
 * >= 193 Intel Core i5-64   Windows 10        Microsoft Visual Studio 2017
 * /DFIX_SEMIBROKEN_PP /arch:AVX  /fp:strict
 * >= 193 Intel Core i5-64   Windows 10        Microsoft Visual Studio 2019
 * /DFIX_SEMIBROKEN_PP /arch:AVX  /fp:strict /std:c17
 * >= 193 Intel Core i5-64   Windows 10        Microsoft Visual Studio 2019
 * /DFIX_SEMIBROKEN_PP /arch:IA32 /fp:strict /std:c17
 * >= 194 Intel Core i5-32   Linux Fedora 30   clang 8.0.0 -std=c17 -m32
 * -mfpmath=sse
 * >= 194 Intel Core i5-64   Linux Fedora 15   clang 2.8; -std=c99 -lm
 * >= 194 Intel Core i5-64   Linux Fedora 16   clang 2.9-10; -std=c99 -lm
 * >= 194 Intel Core i5-64   Linux Fedora 17   clang 3.0-12; -std=c1x
 * -fmath-errno -O0 -lm
 * >= 194 Intel Core i5-64   Linux Fedora 25   clang 3.9.1 -std=c1x -m64
 * -mfpmath=sse
 * >= 194 Intel Core i5-64   Linux Fedora 26   clang 4.0.1 -std=c1x -m64
 * -mfpmath=sse
 * >= 194 Intel Core i5-64   Linux Fedora 27   clang 5.0.1 -std=c1x -m64
 * -mfpmath=sse
 * >= 194 Intel Core i5-64   Linux Fedora 28   clang 6.0.1 -std=c1x -m64
 * -mfpmath=sse
 * >= 194 Intel Core i5-64   Linux Fedora 29   clang 7.0.0 -std=c17 -m64
 * -mfpmath=sse
 * >= 194 Intel Core i5-64   Linux Fedora 29   clang 7.0.1 -std=c17 -m64
 * -mfpmath=sse
 * >= 196 Intel Core i5-32   Linux Fedora 25   clang 3.9.1 -std=c11 -m32
 * -mfpmath=sse
 * >= 196 Intel Core i5-32   Linux Fedora 26   clang 4.0.1 -std=c11 -m32
 * -mfpmath=sse
 * >= 196 Intel Core i5-32   Linux Fedora 27   clang 5.0.2 -std=c11 -m32
 * -mfpmath=sse
 * >= 196 Intel Core i5-32   Linux Fedora 28   clang 6.0.1 -std=c17 -m32
 * -mfpmath=sse
 * >= 196 Intel Core i5-32   Linux Fedora 29   clang 7.0.0 -std=c17 -m32
 * -mfpmath=sse
 * >= 197 Intel Core2 Duo    Linux Fedora 16   clang 2.9-6; -std=c99 -lm
 * >= 197 Intel Core2 Duo    Linux Fedora 17   clang 3.0-10; -std=c1x -pedantic
 * -lm
 * >= 197 Intel Pentium 4    Linux Fedora 15   clang 2.8; -std=c99 -lm
 * >= 198 Intel Core i5-64   Linux Fedora 14   pcc 0.9.9 (2011/02/03) +
 * glibc-2.13-1 (x86_64)
 * >= 201 Intel Core i5-64   Linux Fedora 16   pcc 1.0.0-2 (2011/12/16) +
 * glibc-2.14.90-24 (x86_64)
 * >= 201 Intel Core i5-64   Linux Fedora 26   pcc 1.1.0-1 (2018/05/04) +
 * glibc-2.25.13 (x86_64)
 * >= 213 Intel Core 2 Duo   Windows 7         Microsoft C/C++ VS 2013;
 * /DFIX_SEMIBROKEN_PP
 * >= 213 Intel Core 2 Duo   Windows 7         Microsoft C/C++ VS 2015;
 * /DFIX_SEMIBROKEN_PP
 * >= 213 Intel Core 2 Duo   Windows Vista     Microsoft C/C++ VS 2010;
 * /DFIX_SEMIBROKEN_PP /DFENV_H=\"fenvx87.h\"
 * >= 213 Intel Core i5-64   Windows 10        Microsoft Visual Studio 2017
 * /DFIX_SEMIBROKEN_PP /arch:IA32 /fp:strict
 * >= 213 Intel Pentium 4    Windows XP        Microsoft C/C++ V 14.00 aka
 * Visual Studio 8; semi-broken preprocessor
 * >= 214 IBM Power 6        AIX 6.1.7.17      gcc 4.5.1; -maix64 -lm
 * >= 219 ARM Cortex A53     Android 9+termux  clang 10.0.0 -std=gnu2x -O0 -m32
 * -march=armv7 -mcpu=cortex-a53 -ffp-model=strict
 * >= 219 ARM Cortex A53     Android 9+termux  clang 10.0.1 -std=gnu2x -O0 -m32
 * -march=armv7 -mcpu=cortex-a53 -ffp-model=strict
 * >= 219 ARM Cortex A53     Android 9+termux  clang 10.0.1-1 -std=gnu2x -O0
 * -m32 -march=armv7 -mcpu=cortex-a53 -ffp-model=strict
 * >= 219 ARM Cortex A53     Android 9+termux  clang 10.0.1-2 -std=gnu2x -O0
 * -m32 -march=armv7 -mcpu=cortex-a53 -ffp-model=strict
 * >= 219 DEC Alpha 21064    Linux 2.2.22      Gnu gcc 3.3
 * >= 219 Intel Pentium 4    Windows XP        LCC 2002/05/01 no long long
 * >= 219 Intel Pentium III  OS/2 v4           Gnu gcc 2.5.7 + emx 0.8h; no long
 * long
 ...
 * >= 220 Intel Pentium 4    Windows XP        Microsoft C/C++ V 12.00 aka
 * Visual 6; semi-broken preprocessor
 * >= 220 Intel Pentium III  Windows 98        Microsoft C/C++ V 12.00 aka
 * Visual 6; semi-broken preprocessor
 * >= 225 Apple Mac PPC G4   Mac OS X 10.3.7   Gnu gcc 3.3 (build 1495)
 * >= 225 Apple PowerPC G4 7450 MacOS 10.2.5   Gnu gcc 3.3.2 w/ glibc ?
 * >= 273 ARM Cortex A53     Android 9         clang 9.0.1 -O0 -lm
 * >= 273 ARM Cortex A53     Android 9         clang 9.0.1 -O2 -lm
 * >= 273 ARM aarch64        ?                 clang 10.0.0 -O2
 * >= 273 Intel Core2 Duo    Windows Vista     Borland C/C++ 5.5 w/
 * -DFENV_H="fenvx87.h" -DNEED_TRAPS_DISABLED
 * -DFPU_DISABLE_TRAPS="(void)_control87( 0x003fu, 0x003fu );"
 ...
 * >= 285 Intel Pentium Pro  RedHat Linux 4    Gnu gcc 2.7.2.1 + libc 5.3.12 +
 * libg++ 2.7.1.4
 ...
 * ?????? Intel Pentium III  OS/2 v4+DOS       Borland Turbo C v2 [dies in
 * preprocessor]
 * ?????? Intel Pentium III  OS/2 v4+DOS       Symantec C/C++ v7.01 [dies in
 * preprocessor]
 * ?????? Intel Pentium III  Windows 98        Digital Mars 8.16 [dies in
 * preprocessor]
 * ?????? Intel Pentium III  Windows 98        Digital Mars 8.19 [dies in
 * preprocessor]
 * ?????? Intel Pentium III  Windows 98        Digital Mars 8.20 [dies in
 * preprocessor]
 * ?????? Intel Pentium Pro  OS/2 v4+DOS       Symantec C/C++ v7.01 [dies in
 * preprocessor]
 * ?????? Intel Pentium Pro  Windows NT        Microsoft C/C++ 10.10.6038 [dies
 * in preprocessor]
 ...
 * abort  Intel Pent 4 IA-32 Linux Fedora 10   Intel C/C++ icc 11.1 -std=c99
 * -strict-ansi -msse3 -fp-model strict -O0 abort  Intel Pentium 4    Windows XP
 *        LCC 2006/04/10; [dies at runtime] abort  Intel Pentium III  OS/2
 * v4+DOS       Borland C/C++ v4 [dies at runtime] abort  Intel Pentium III
 * Windows 98        LCC 2002/06/06 no long long; [dies at runtime] abort  Intel
 * Pentium III  Windows 98        LCC 2002/06/09 [dies at runtime] abort  Intel
 * Pentium III  Windows 98        LCC 2002/06/17 [dies at runtime] abort  Intel
 * Pentium III  Windows 98        LCC 2002/10/03 [dies at runtime] abort  Intel
 * Pentium III  Windows 98        LCC 2002/11/30 [dies at runtime] abort  Intel
 * Pentium III  Windows 98        LCC 2003/01/12 [dies at runtime] abort  Intel
 * Pentium Pro  Windows NT        IBM VisualAge for C/C++ 3.5.7 [dies at run
 * time]
 *
 * The following were tests of just i = +f;  that is, no tests of i = -f;  Need
 * to be rerun.
 * >= 144 UltraSparc III (v8+)  ?              Forte 7: cc -lm9x -xc99
 * -xtarget=native -xarch=native
 * >= 144 UltraSparc III (v8+b) ?              Forte 7: cc -lm9x -xc99
 * -xtarget=native -xarch=native
 * >= 144 UltraSparc III (v9)   ?              Forte 7: cc -lm9x -xc99
 * -xtarget=native -xarch=native
 ...
 * 2020/06/24 - Add more gcc, clang, pcc results.
 *
 ***********************************************************************/
...
#define DEF_TSTS(N, PRT, I_TYPE, FMT, I_MAX, I_MIN, F_TYPE, F_MAX_EXP)         \
  static void STN(N)(void) {                                                   \
    ...
    if (PRT)                                                                   \
      (void)printf(                                                            \
          "Testing conversion from " STR(F_TYPE) " to " STR(I_TYPE) "\n");     \
    want = (I_TYPE)1;                                                          \
  ...
  static void STN(N)(void) {                                                   \
    ...
    for (j = 0uL; (j < max_exp); j++) {                                        \
      ...
      if ((~(FE_INVALID)) & flags) {                                           \
        lcl_failed++;                                                          \
        (void)printf(                                                          \
            "-f: j=%lu, expected just FE_INVALID, got: %#x; i2 is " FMT "\n",  \
            j, (unsigned)flags, i2);                                           \
      }                                                                        \
      RAISE_ALL;                                                               \
      /*lint -e524 -e732 -e919 */                                              \
...
#define DEF_TEST_SI(args) DEF_TSTS args
    ...
    (!defined FIX_ULLONG_RANDOM_INVALID)
DEF_TESTU(00, ULL, LD)
#endif
...
int main(void) {
...
#ifndef RETVAL
  (void)printf("This program tests conversions from floating-point types to "
               "integer types.\n");
  (void)printf("It tests positive powers of 2.0, e.g., f = 2.0**j\n");
  (void)printf("It tests both i = +f; and i = -f;\n");
  (void)printf("For numbers that are representable, it checks expected value "
               "and no exceptions.\n");
  (void)printf("For numbers that are NOT representable, it checks for "
               "FE_INVALID exception.\n");
#endif

#ifndef __STDC_IEC_559__
  (void)printf("This implementation does not claim conformance to IEC-60559 or "
               "IEEE-754\n");
  (void)printf(
  ...
  if (0 == allflags) {
    ...
    NumFail++;
    (void)printf(
        "Failed due to RAISE_ALL or fetestexcept not doing FE_INVALID.\n");
  }
#endif
...
#endif
#ifdef DFP_TEST_LVL
    (void)printf("DFP_TEST_LVL is %li\n", (long int)DFP_TEST_LVL);
#endif
#ifdef FPCE_TEST_LVL
    (void)printf("FPCE_TEST_LVL is %li\n", (long int)FPCE_TEST_LVL);
#endif
  }
